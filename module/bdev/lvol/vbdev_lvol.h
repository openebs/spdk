...
typedef void (*spdk_lvs_timeout_cb)(struct spdk_lvol_store *lvs, void *cb_arg);

struct lvstore_timeout_cb_args {
	struct spdk_lvol_store *lvs;
	spdk_lvs_timeout_cb cb_fn;
	void *cb_arg;
};
 ...
 * \param addition callback arguments
 */
